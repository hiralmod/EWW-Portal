                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        <div class="form-group mb-3">
                           ...
                           <input type="text" name="name" class="form-control" placeholder="Enter State Name" required="" data-parsley-required-message="Please enter state name" maxlength="25" data-parsley-minlength="2" data-parsley-minlength-message="Minimum 2 characters are required" >
                        </div>

                        <div class="form-group mb-3">
                           <label>Code</label>
                           <input type="text" name="code" class="form-control" required="" placeholder="Enter State Code" data-parsley-required-message="Please enter state code" maxlength="10" data-parsley-minlength="2" data-parsley-minlength-message="Minimum 2 characters are required" >
                         </div>
                     </div>
